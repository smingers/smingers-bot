...
Question background:
This question tracks the exact target policy rate set by the State Bank of Pakistan (SBP) as of May 1, 2026. The policy rate is a critical tool for managing inflation and economic growth in Pakistan, influencing commercial interest rates and the value of the Pakistani Rupee.

`{"format":"bot_tournament_question","info":{"hash_id":"47ebb9c64990e164"}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
This question resolves to the value of the State Bank of Pakistan (SBP) target policy rate (also known as the 'Policy Rate') in effect at 11:59 PM UTC on May 1, 2026. The resolution will be based on the official 'Monetary Policy Statements' published by the State Bank of Pakistan on its official website (https://www.sbp.org.pk/) or [credible sources](https://www.metaculus.com/faq/#definitions).
...
Question metadata:
- Opened for forecasting: 2026-01-30T00:00:00Z
