...
How many vehicle deliveries will Rivian report for Q1 2026?

Question background:
[Rivian R2 validation units roll off production line, deliveries to follow ‘soon’](https://electrek.co/2026/01/15/rivian-starts-producing-r2-validation-units-deliveries-follow-soon/)

`{"format":"bot_tournament_question","info":{"hash_id":"8600dea27cd5895d","sheet_id":138}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
This question resolves as the total number of vehicle deliveries of all models [reported by Rivian](https://rivian.com/investors) for the first quarter of 2026.

Additional fine-print:


Question metadata:
- Opened for forecasting: 2026-01-30T22:30:00Z
