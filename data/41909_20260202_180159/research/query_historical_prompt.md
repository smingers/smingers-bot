...
What will be the reported Q1 2026 global revenue for Mounjaro?

Question background:
Mounjaro, a type II diabetes medication also used for weight loss,  is a key driver of Eli Lilly's growth in the obesity market, and its performance is a major indicator of the company's ability to scale production and meet high consumer demand.

`{"format":"bot_tournament_question","info":{"hash_id":"2dc820a644032515","sheet_id":67}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
This question resolves to the value of the 'Global' or 'Total' net sales (revenue) for Mounjaro for the first quarter (Q1) of 2026, as reported in Eli Lilly and Company's quarterly earnings materials. Resolution will be based on the first official earnings release or SEC filing (10-Q) issued by Eli Lilly and Company for the quarter ending March 31, 2026. Source: https://investor.lilly.com/financial-information/quarterly-results
...
Question metadata:
- Opened for forecasting: 2026-02-02T18:00:00Z
...
The lower bound is 0.0 and the upper bound is 20000000000.0.
The lower bound is CLOSED (outcome cannot be below 0.0), but the upper bound is OPEN (outcome can exceed 20000000000.0). Your upper percentiles may extend beyond the upper bound if evidence supports it.
