...
What will be the value of "ICE BofA US High Yield Index Total Return Index Value" on 2026-02-13?

Question background:
The Federal Reserve Economic Data database (FRED) provides economic data from national, international, public, and private sources. The series BAMLHYH0A0HYM2TRIV is a dataset that is tracked by the FRED API. It represents the total return of the ICE BofA US High Yield Index, which tracks the performance of below investment grade corporate debt publicly issued in the US domestic market. The title of the series is "ICE BofA US High Yield Index Total Return Index Value". The last data point on the graph (as of creation of this question) is from 2026-01-29 and has a value of 1876.28. The units of the series are "Index". The update frequency of the series is "Daily". The seasonal adjustment of the series is "Not Seasonally Adjusted". An interactive graph for the series can be found [here](https://fred.stlouisfed.org/series/BAMLHYH0A0HYM2TRIV). Below are the notes attached to the series:
...
`{"format":"fred_value_at_time","info":{"series_id":"BAMLHYH0A0HYM2TRIV"}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
Resolves to the value found on the FRED API for the series BAMLHYH0A0HYM2TRIV once the data is published.

Additional fine-print:


Question metadata:
- Opened for forecasting: 2026-02-02T10:02:08Z
- Resolves: 2026-02-13T05:07:43Z
...
The lower bound is 1439.64857 and the upper bound is 2161.42293.
