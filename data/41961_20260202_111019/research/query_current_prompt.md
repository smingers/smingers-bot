...
What will be the value of "Market Yield on U.S. Treasury Securities at 5-Year Constant Maturity, Quoted on an Investment Basis" on 2026-02-10?

Question background:
The Federal Reserve Economic Data database (FRED) provides economic data from national, international, public, and private sources. The series DGS5 is a dataset that is tracked by the FRED API. It represents the market yield on US treasury securities at 5-year constant maturity, quoted on an investment basis. The title of the series is "Market Yield on U.S. Treasury Securities at 5-Year Constant Maturity, Quoted on an Investment Basis". The last data point on the graph (as of creation of this question) is from 2026-01-29 and has a value of 3.8. The units of the series are "Percent". The update frequency of the series is "Daily". The seasonal adjustment of the series is "Not Seasonally Adjusted". An interactive graph for the series can be found [here](https://fred.stlouisfed.org/series/DGS5). Below are the notes attached to the series:
...
`{"format":"fred_value_at_time","info":{"series_id":"DGS5"}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
Resolves to the value found on the FRED API for the series DGS5 once the data is published.

Additional fine-print:


Question metadata:
- Opened for forecasting: 2026-02-02T10:39:12Z
- Resolves: 2026-02-10T11:13:32Z
...
The lower bound is 3.026 and the upper bound is 5.03792.
