...
Question background:
The Federal Reserve Economic Data database (FRED) provides economic data from national, international, public, and private sources. The series DTWEXBGS is a dataset that is tracked by the FRED API. It represents the Nominal Broad US Dollar Index, a weighted average of the foreign exchange value of the US dollar against currencies of a broad group of major US trading partners. The title of the series is "Nominal Broad U.S. Dollar Index". The last data point on the graph (as of creation of this question) is from 2026-01-23 and has a value of 119.2855. The units of the series are "Index Jan 2006=100". The update frequency of the series is "Daily". The seasonal adjustment of the series is "Not Seasonally Adjusted". An interactive graph for the series can be found [here](https://fred.stlouisfed.org/series/DTWEXBGS). Below are the notes attached to the series:
