...
Question background:
The Federal Funds Target Range is the primary tool used by the Federal Reserve to influence economic conditions in the United States. This question tracks the upper bound of that range as of March 31, 2026.

`{"format":"bot_tournament_question","info":{"hash_id":"037be701c5e6a1c6","sheet_id":65.2}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
This question resolves to the value of the upper bound of the target range for the federal funds rate as set by the Federal Open Market Committee (FOMC), effective on March 31, 2026. The primary source for resolution is the Federal Reserve Board's official 'Implementation Note' or 'Policy Statement' issued following the most recent FOMC meeting prior to or on March 31, 2026. If the Federal Reserve specifies a single target rate rather than a range, that single rate will serve as the resolution value. Resolves based on data from the Federal Reserve Bank of St. Louis (FRED) series 'DFEDTARU' (https://fred.stlouisfed.org/series/DFEDTARU)
...
Question metadata:
- Opened for forecasting: 2026-02-09T06:00:00Z
...
The lower bound is 0.0 and the upper bound is 7.0.
