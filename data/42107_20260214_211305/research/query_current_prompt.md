...
What will be the statewide voter turnout percentage in Bavaria’s local elections (Kommunalwahlen)?

Question background:
The election is scheduled for March 8, 2026.  Turnout is a key signal of local political engagement and can shift party performance and mandate legitimacy.

`{"format":"bot_tournament_question","info":{"hash_id":"bca1bd79ad060cd6","sheet_id":197.1}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
This question resolves to the statewide turnout percentage (“Wahlbeteiligung”, in %) for Bavaria’s Kommunalwahlen as published before May 1, 2026 by the Bayerisches Landesamt für Statistik on its Kommunalwahlen page: https://www.statistik.bayern.de/wahlen/kommunalwahlen/index.html.
...
Question metadata:
- Opened for forecasting: 2026-02-14T21:00:00Z
...
The lower bound is 25 and the upper bound is 80.
