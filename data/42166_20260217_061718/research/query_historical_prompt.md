...
Will the community prediction be higher than 6.00% on 2026-02-28 for the Metaculus question "Will the United States gain formal sovereignty over any part of Greenland during 2026?"?
...
`{"format":"metaculus_binary_cp_rises","info":{"post_id":41502,"question_id":41231,"last_cp":0.06}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
This question will resolve based on the community prediction of the Metaculus question found [here](https://www.metaculus.com/questions/41502) (i.e. the 'target question'). If the community prediction of the target question on 2026-02-28 16:49:57 is higher than 6.00%, this question will resolve to 'Yes'. If it is lower or equal to 6.00%, this question will resolve to 'No'. If the target question has already resolved before this question opens, then this question will be annulled. If the target question resolves after this question opens, but before 2026-02-28 16:49:57, then this question will resolve to the same value as the target question.

Additional fine-print:


Question metadata:
- Opened for forecasting: 2026-02-17T05:35:59Z
- Resolves: 2026-02-28T16:49:57Z
