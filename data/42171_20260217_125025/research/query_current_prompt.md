...
Question background:
The Federal Reserve Economic Data database (FRED) provides economic data from national, international, public, and private sources. The series OBMMIVA30YF is a dataset that is tracked by the FRED API. It represents the 30-year fixed rate Veterans Affairs mortgage index. The title of the series is "30-Year Fixed Rate Veterans Affairs Mortgage Index". The last data point on the graph (as of creation of this question) is from 2026-02-12 and has a value of 5.633. The units of the series are "Percent". The update frequency of the series is "Daily". The seasonal adjustment of the series is "Not Seasonally Adjusted". An interactive graph for the series can be found [here](https://fred.stlouisfed.org/series/OBMMIVA30YF). Below are the notes attached to the series:

> This index includes rate locks from U.S. Department of Veterans Affairs loans.
> 
...
`{"format":"fred_value_at_time","info":{"series_id":"OBMMIVA30YF"}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
Resolves to the value found on the FRED API for the series OBMMIVA30YF once the data is published.
...
Question metadata:
- Opened for forecasting: 2026-02-17T12:45:36Z
- Resolves: 2026-02-26T07:48:44Z
...
The lower bound is 4.789962 and the upper bound is 7.51502.
