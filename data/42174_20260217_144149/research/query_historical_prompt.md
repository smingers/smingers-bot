...
Question background:
The Federal Reserve Economic Data database (FRED) provides economic data from national, international, public, and private sources. The series SOFR is a dataset that is tracked by the FRED API. It represents the Federal Reserve's Secured Overnight Financing Rate. The title of the series is "Secured Overnight Financing Rate". The last data point on the graph (as of creation of this question) is from 2026-02-12 and has a value of 3.65. The units of the series are "Percent". The update frequency of the series is "Daily". The seasonal adjustment of the series is "Not Seasonally Adjusted". An interactive graph for the series can be found [here](https://fred.stlouisfed.org/series/SOFR). Below are the notes attached to the series:

No notes available

`{"format":"fred_value_at_time","info":{"series_id":"SOFR"}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
Resolves to the value found on the FRED API for the series SOFR once the data is published.
...
Question metadata:
- Opened for forecasting: 2026-02-17T13:59:10Z
- Resolves: 2026-02-26T20:02:35Z
...
The lower bound is 3.094 and the upper bound is 5.09542.
