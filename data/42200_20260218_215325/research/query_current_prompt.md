...
What will be the value of "Crude Oil Prices: West Texas Intermediate (WTI) - Cushing, Oklahoma" on 2026-02-26?

Question background:
The Federal Reserve Economic Data database (FRED) provides economic data from national, international, public, and private sources. The series DCOILWTICO is a dataset that is tracked by the FRED API. It represents the price of West Texas Intermediate (WTI - Cushing) crude oil. The title of the series is "Crude Oil Prices: West Texas Intermediate (WTI) - Cushing, Oklahoma". The last data point on the graph (as of creation of this question) is from 2026-02-09 and has a value of 64.53. The units of the series are "Dollars per Barrel". The update frequency of the series is "Daily". The seasonal adjustment of the series is "Not Seasonally Adjusted". An interactive graph for the series can be found [here](https://fred.stlouisfed.org/series/DCOILWTICO). Below are the notes attached to the series:

> Definitions, Sources and Explanatory Notes (http://www.eia.doe.gov/dnav/pet/TblDefs/pet_pri_spt_tbldef2.asp)

`{"format":"fred_value_at_time","info":{"series_id":"DCOILWTICO"}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
Resolves to the value found on the FRED API for the series DCOILWTICO once the data is published.
...
Question metadata:
- Opened for forecasting: 2026-02-18T21:31:21Z
- Resolves: 2026-02-26T13:27:33Z
...
The lower bound is 47.714325 and the upper bound is 86.08279.
