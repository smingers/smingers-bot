...
Will the IOM Missing Migrants Project record at least 800 Mediterranean migrant deaths in 2026 before March 2026?

Question background:
This tracks the scale of lethal migration risk in the Mediterranean in early 2026, which is relevant for humanitarian planning and policy response.

`{"format":"bot_tournament_question","info":{"hash_id":"ba81abff6451e220","sheet_id":262.3}}`

This question's outcome will be determined by the specific criteria below. These criteria have not yet been satisfied:
This question resolves to Yes if the IOM Missing Migrants Project incident dataset shows that the year-to-date sum of dead plus missing through the end of February 2026 for “Mediterranean” is at least 800.The primary source is the IOM Missing Migrants Project public site : https://missingmigrants.iom.int/region/mediterranean

Additional fine-print:


Question metadata:
- Opened for forecasting: 2026-02-22T10:30:00Z
