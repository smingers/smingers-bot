...
|-------|-------|
| Actual Outcome | **Yes** |
| Final Prediction | 36.2% (Yes) |
| Brier Score | 0.4070 |
| Correct Direction | ❌ No |
| Community Prediction | 45% |
| Spot Peer Score | -24.0 |
| Spot Baseline Score | -46.6 |

### Retrospective
- Forecast was on the wrong side (36.2% → resolved Yes)
- Underperformed peers by -24.0 spot peer score
