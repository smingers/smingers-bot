...
| Probability on Correct Answer | 32.0% |
| Correct? | ❌ No |
| Spot Peer Score | -27.4 |
| Spot Baseline Score | -3.7 |

### Retrospective
- Predicted Decreases but resolved Doesn't change
- Underperformed peers by -27.4 spot peer score
